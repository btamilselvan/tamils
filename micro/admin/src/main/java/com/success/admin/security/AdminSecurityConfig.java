package com.success.admin.security;
...
public class AdminSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  @Autowired private AdminServerProperties adminServer;
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    successHandler.setDefaultTargetUrl(this.adminServer.getContextPath() + "http://localhost:8086/admin/");
